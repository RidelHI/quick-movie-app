...
- src/app/core: singletons, configuracion, http, interceptors, error handling, logging.
- src/app/shared: UI reutilizable, pipes, directivas y utilidades puras.
- src/app/domain: modelos, DTOs y mappers por dominio.
- src/app/features: features aisladas por dominio funcional.
- src/app/labs/experimental: area para features nuevas o inestables de Angular 21.

## Estructura por feature
- feature: rutas, containers y orquestacion del caso de uso.
- data-access: store, efectos, servicios de datos y adaptadores.
- ui: componentes presentacionales y composicion de layout.
